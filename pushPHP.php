    ...
    <section id="contact-page">
        <div class="container">
            ...
            <div class="row contact-wrap"> 
                ...
                <form id="main-contact-form" enctype="multipart/form-data" class="contact-form" name="contact-form" method="post" action="pushPHP.php">
                    ...
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <select name="subjectOption" id="subjectId" onclick="branchChange();" required="required">
